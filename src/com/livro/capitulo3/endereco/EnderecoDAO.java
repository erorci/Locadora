...
public class EnderecoDAO {
	...
	public void salvar(Endereco endereco) {
		try {
			...
			System.out.println("Não foi possível inserir o endereco. Erro: " + e.getMessage());
		} finally {
			try {
	...
	public void atualizar(Endereco endereco) {
		try {
			...
			System.out.println("Não foi possível alterar o endereco. Erro: " + e.getMessage());
		} finally {
			try {
				if (this.sessao.isOpen()) {
					this.sessao.close();
	...
	public void excluir(Endereco endereco) {
		try {
			...
			System.out.println("Não foi possível excluir o endereco. Erro: " + e.getMessage());
		} finally {
			try {
				if (this.sessao.isOpen()) {
					this.sessao.close();
